...
@Component
public class FilterCircuitConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String submittedValue) {
        ...
        try {
            return filterCircuitService.getAll().get(Integer.valueOf(submittedValue));
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object modelValue) {
        ...
        if (modelValue instanceof FilterCircuit) {
            // TODO: ЕРЕСЬ!!!!!
            return  String.valueOf(filterCircuitService.getAll().indexOf(modelValue));
        } else {
