...
@Component
public class HeatExchangerConverter implements Converter {

    @Autowired
    HeatExchangerService heatExchangerService;
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String submittedValue) {
        ...
        try {
            return heatExchangerService.getAll().get(Integer.valueOf(submittedValue));
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object modelValue) {
        ...
        if (modelValue instanceof HeatExchanger) {
            // TODO: ЕРЕСЬ!!!!!
            return String.valueOf(heatExchangerService.getAll().indexOf(modelValue));
        } else {
